@echo off
title Повне видалення Rony PC Agent з ПК
chcp 65001 > NUL
cd /d "%~dp0"

echo ========================================================
echo 🗑️ ПОВНЕ ВИДАЛЕННЯ RONY PC AGENT 
echo ========================================================
echo.
...
echo [2/3] Видалення з Автозавантаження Windows (Startup & Registry)...
...
echo.
echo Тепер ви можете перезапустити агента з 0:
echo 1. Запустіть "install_startup.bat" для повторного встановлення
echo 2. Або запустіть "run_agent.bat" для одноразового запуску.
echo ========================================================
echo.
pause